...
export const metadata: Metadata = {
  title: "Privacy Policy - Earlier or Later",
  description: "Privacy Policy for Earlier or Later. Learn how we handle your data and protect your privacy while playing our history game.",
};
      ...
      <main className="flex-1 min-h-0 flex flex-col items-center justify-start px-4 py-6 overflow-y-auto">
        <article className="max-w-3xl w-full prose dark:prose-invert">
          ...
          <section className="mb-6">
            ...
            <p className="mb-4">
              Earlier or Later (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) is committed to protecting your privacy. 
          ...
          <section className="mb-6">
            ...
            <p className="mb-4">
              Earlier or Later is designed to be privacy-friendly. We collect minimal information:
            </p>
