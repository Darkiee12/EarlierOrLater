  ...
  return (
    <div className="w-full h-full">
      {(gameStatus === "lobby" || gameStatus === "loading") && (
        <Lobby useGameContext={useFreePlayGame} gameMode="freeplay" />
      )}
      {gameStatus === "ongoing" && (
        <GameInnerPanel useGameContext={useFreePlayGame} />
      )}
      {gameStatus === "finished" && (
        <GameResult useGameContext={useFreePlayGame} />
      )}
    </div>
  );
};

const FreeClassicPage = () => {
  return (
...
export default FreeClassicPage;
